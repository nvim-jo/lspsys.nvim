local api = vim.api
local float = require('lspsys.layout.float')
local normal = require('lspsys.layout.normal')
local M = {}
...
function M:dropdown(height)
  ...
  --down
  self.left_bufnr, self.left_winid = require('lspsys.layout.normal').left(height, nil, _, true)
  return self
end
